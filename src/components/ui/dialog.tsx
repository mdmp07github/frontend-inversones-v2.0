...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 border-b py-2 text-center sm:text-left", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "bg-muted/50 -mx-4 -mb-4 rounded-b-xl border-t py-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
